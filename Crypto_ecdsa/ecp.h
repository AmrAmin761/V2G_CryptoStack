...
typedef struct mbedtls_ecp_curve_info
{
    ...
    uint16 tls_id;                /*!< The TLS NamedCurve identifier. */
    uint16 bit_size;              /*!< The curve size in bits. */
    const char *name;               /*!< A human-friendly name. */
} mbedtls_ecp_curve_info_s;
...
typedef struct mbedtls_ecp_group
{
    ...
    mbedtls_ecp_point_s G;        /*!< The generator of the subgroup used. */
    ...
    int (*modp)(mbedtls_mpi *); /*!< The function for fast pseudo-reduction
                                     mod \p P (see above).*/
    int (*t_pre)(mbedtls_ecp_point_s *, void *);  /*!< Unused. */
    int (*t_post)(mbedtls_ecp_point_s *, void *); /*!< Unused. */
    void *t_data;               /*!< Unused. */
    mbedtls_ecp_point_s *T;       /*!< Pre-computed points for ecp_mul_comb(). */
...
{
    mbedtls_ecp_group_s grp;      /*!<  Elliptic curve and base point     */
    mbedtls_mpi d;              /*!<  our secret value                  */
    mbedtls_ecp_point_s Q;        /*!<  our public value                  */
}
mbedtls_ecp_keypair_s;
 ...
 *                  mbedtls_ecp_curve_info_s() for all supported curves in order
 *                  of preference.
 *
 ...
 */
int mbedtls_ecp_group_copy( mbedtls_ecp_group_s *const dst,
                            const mbedtls_ecp_group_s *const src );
 ...
 *                  ::mbedtls_ecp_keypair_s structure, to ease use with other

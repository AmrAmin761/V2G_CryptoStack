...
V2X_SCH4=172,		/*172	 Service channel 4*/
V2X_SCH3=174,		/*174	 Service channel 3*/
V2X_SCH1=176,		/*176 	 Service channel 1*/
V2X_SCH2=178,		/*178 	 Service channel 2*/
V2X_CCH=180			/*180 	 Control channel */

}V2x_ChanType;


/*[SWS_V2xM_00115] : Used for return values of security related functions*/
typedef enum{
	V2X_V2X_E_OK,			/*Return with success*/
	V2X_V2X_E_NOT_OK,		/*Failure during operation*/

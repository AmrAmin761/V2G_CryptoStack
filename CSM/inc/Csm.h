...
extern const Crypto_JobPrimitiveInfoType signature_info;
extern const Crypto_JobPrimitiveInfoType verify_info;
extern const Crypto_JobPrimitiveInfoType hash_info;
